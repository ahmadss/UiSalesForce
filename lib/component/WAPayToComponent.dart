...
import 'package:salesforce/component/WAPaymentCompeteDialog.dart';
import 'package:salesforce/component/WASendViaComponent.dart';
...
import 'package:salesforce/utils/widgets/slider.dart';
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Stack(
            ...
            children: [
              Container(height: 100, width: 250, decoration: boxDecorationRoundedWithShadow(16), margin: EdgeInsets.only(top: 30)),
              Column(
                children: [
                  Container(
                    width: 60,
          ...
          AppTextField(
            autoFocus: false,
            decoration: waInputDecoration(hint: "Enter your name here", bgColor: Colors.white, borderColor: Colors.grey),
          ...
          AppTextField(
            autoFocus: false,
            decoration: waInputDecoration(hint: "Enter your phone No. here", bgColor: Colors.white, borderColor: Colors.grey),
